  ...
  login() {
    ...
    this._serviceAuth.login(criteria).subscribe((data) => {
      if (data.msg != 'OK') {
        ...
        this.openSnackBar(
          this._translateService.instant(texto_retorno),
        ...
        if (data.result.migrado == 'NOT') {
          ...
          this.openSnackBar(
            this._translateService.instant('aut-module.input.login-exitoso'),
            ...
            if (data.msg == 'OK') {
              this.openSnackBar(
                this._translateService.instant(
                  'aut-module.input.crear-exitoso'
                ),
                'custom-snackbar_exitoso'
              );
              ...
              if (data.msg == 'user_ocupado') {
                this.openSnackBar(
                  this._translateService.instant('general-msg.usuario-ocupado'),
                  'custom-snackbar_fallido'
                );
              } else if (data.msg == 'correo_ocupado') {
                this.openSnackBar(
                  this._translateService.instant('general-msg.correo-ocupado'),
                  'custom-snackbar_fallido'
                );
              } else {
                this.openSnackBar(
                  this._translateService.instant(
                    'aut-module.input.crear-fallido'
                  ),
                  'custom-snackbar_fallido'
                );
              }
